 ...
 * @param delimiter the character which deliminates (splits up) the data /What in the file is deliminating the data
 * //All of these are pointers
 * //You need to use pointers to get C to store things
...
{
    int line_number = 0;
    //Making an array of 100 SONG_DATA structs
    SONG_DATA songs[100];
    int buffer_size = 250;
